    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo">
             <a href="index.php">
              <h5 style="font-size: 16px;">Car Hiring System</h5>
              <h6 style="font-size: 10px; color:brown;">Project By Davis Meru</h6>
            </a>
          </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <p class="uppercase_text">Reach out : </p>
              <a href="mailto:info@example.com">davismeru911@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Contact us: </p>
              <a href="tel:61-1234-5678-09">+254717214046</a> </div>
            <div class="social-follow">
              <ul>
                ...
                <li><a href="https://github.com/" target="_blank"><i class="fa fa-github-square" aria-hidden="true"></i></a></li>
